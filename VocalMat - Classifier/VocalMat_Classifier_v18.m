...
%                 end
        ...
        [pks,locs,~,proms]=findpeaks(yy2,'MinPeakProminence',0.3); %The peak has to present local height of at least 0.3 to be considered a peak
        ...
        try 
            title(['pk1/pk2= ' num2str(max_peak.peak/ max_peak2.peak) ' ;  mean(pks)/mean(valleys):'  num2str(mean(pks)/mean(valleys)) '; max_prom= ' num2str(max(proms))])
        catch
            title(['pk1= ' num2str(max_peak.peak) ' ;  mean(pks)/mean(valleys):'  num2str(mean(pks)/mean(valleys)) '; max_prom= ' num2str(max(proms))])
        end
%         ylim([0 1])
...
%         subplot(2,2,4), plot(xi,f), title(k)
        subplot(2,2,4),plot(F_orig,test3)
