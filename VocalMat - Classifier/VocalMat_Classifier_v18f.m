...
%     noise_detected_clustering = zeros(length(max_prom),1);
    ...
    names = [{'Names_vocal'};{'Start_time'}; {'End_time'}; {'Duration'}; {'min_freq_main'}; {'max_freq_main'};{'mean_freq_main'};{'min_freq_total'};...
...
%     tabela.Properties.VariableNames = names;
    ...
    for i=1:size(time_vocal,2)
        ...
        min_freq_main(i) = min(current_freq_total{i});
        max_freq_main(i) = max(current_freq_total{i});
    ...
    tabela(:,4) = num2cell(duration');
    tabela(:,5) = num2cell(min_freq_main');
    tabela(:,6) = num2cell(max_freq_main');
    tabela(:,7) = num2cell(mean_freq_main');
    tabela(:,8) = num2cell(min_freq_total');
    tabela(:,9) = num2cell(max_freq_total');
    tabela(:,10) = num2cell(mean_freq_total');
    tabela(:,11) = num2cell(min_intens_total');
    tabela(:,12) = num2cell(max_intens_total');
    tabela(:,13) = num2cell(mean_intens_total');
...
if 1==0
    ...
    disp('Step up:')
    disp(['Bin1: ' num2str(stepup_count_bin_total(1)) ', Bin2: ' num2str(stepup_count_bin_total(2)) ', Bin3: ' num2str(stepup_count_bin_total(3)) ', Bin4: ' num2str(stepup_count_bin_total(4)) ', Bin5: ' num2str(stepup_count_bin_total(5)) ', Bin6: ' num2str(stepup_count_bin_total(6))]);
    disp('Step down:')
    disp(['Bin1: ' num2str(stepdown_count_bin_total(1)) ', Bin2: ' num2str(stepdown_count_bin_total(2)) ', Bin3: ' num2str(stepdown_count_bin_total(3)) ', Bin4: ' num2str(stepdown_count_bin_total(4)) ', Bin5: ' num2str(stepdown_count_bin_total(5)) ', Bin6: ' num2str(stepdown_count_bin_total(6))]);
    disp('Harmonics:')
    disp(['Bin1: ' num2str(harmonic_count_bin_total(1)) ', Bin2: ' num2str(harmonic_count_bin_total(2)) ', Bin3: ' num2str(harmonic_count_bin_total(3)) ', Bin4: ' num2str(harmonic_count_bin_total(4)) ', Bin5: ' num2str(harmonic_count_bin_total(5)) ', Bin6: ' num2str(harmonic_count_bin_total(6))]);
    disp('Flat:')
    disp(['Bin1: ' num2str(flat_count_bin_total(1)) ', Bin2: ' num2str(flat_count_bin_total(2)) ', Bin3: ' num2str(flat_count_bin_total(3)) ', Bin4: ' num2str(flat_count_bin_total(4)) ', Bin5: ' num2str(flat_count_bin_total(5)) ', Bin6: ' num2str(flat_count_bin_total(6))]);
    disp('Chevron:')
    disp(['Bin1: ' num2str(chevron_count_bin_total(1)) ', Bin2: ' num2str(chevron_count_bin_total(2)) ', Bin3: ' num2str(chevron_count_bin_total(3)) ', Bin4: ' num2str(chevron_count_bin_total(4)) ', Bin5: ' num2str(chevron_count_bin_total(5)) ', Bin6: ' num2str(chevron_count_bin_total(6))]);
    disp('Rev Chevron:')
    disp(['Bin1: ' num2str(revchevron_count_bin_total(1)) ', Bin2: ' num2str(revchevron_count_bin_total(2)) ', Bin3: ' num2str(revchevron_count_bin_total(3)) ', Bin4: ' num2str(revchevron_count_bin_total(4)) ', Bin5: ' num2str(revchevron_count_bin_total(5)) ', Bin6: ' num2str(revchevron_count_bin_total(6))]);
    disp('Down FM:')
    disp(['Bin1: ' num2str(downfm_count_bin_total(1)) ', Bin2: ' num2str(downfm_count_bin_total(2)) ', Bin3: ' num2str(downfm_count_bin_total(3)) ', Bin4: ' num2str(downfm_count_bin_total(4)) ', Bin5: ' num2str(downfm_count_bin_total(5)) ', Bin6: ' num2str(downfm_count_bin_total(6))]);
    disp('Up FM:')
    disp(['Bin1: ' num2str(upfm_count_bin_total(1)) ', Bin2: ' num2str(upfm_count_bin_total(2)) ', Bin3: ' num2str(upfm_count_bin_total(3)) ', Bin4: ' num2str(upfm_count_bin_total(4)) ', Bin5: ' num2str(upfm_count_bin_total(5)) ', Bin6: ' num2str(upfm_count_bin_total(6))]);
    disp('Complex:')
    disp(['Bin1: ' num2str(complex_count_bin_total(1)) ', Bin2: ' num2str(complex_count_bin_total(2)) ', Bin3: ' num2str(complex_count_bin_total(3)) ', Bin4: ' num2str(complex_count_bin_total(4)) ', Bin5: ' num2str(complex_count_bin_total(5)) ', Bin6: ' num2str(complex_count_bin_total(6))]);
    disp('Noisy Vocal:')
    disp(['Bin1: ' num2str(noisy_vocal_count_bin_total(1)) ', Bin2: ' num2str(noisy_vocal_count_bin_total(2)) ', Bin3: ' num2str(noisy_vocal_count_bin_total(3)) ', Bin4: ' num2str(noisy_vocal_count_bin_total(4)) ', Bin5: ' num2str(noisy_vocal_count_bin_total(5)) ', Bin6: ' num2str(noisy_vocal_count_bin_total(6))]);
    disp('Non Linear:')
    disp(['Bin1: ' num2str(nonlinear_count_bin_total(1)) ', Bin2: ' num2str(nonlinear_count_bin_total(2)) ', Bin3: ' num2str(nonlinear_count_bin_total(3)) ', Bin4: ' num2str(nonlinear_count_bin_total(4))  ', Bin5: ' num2str(nonlinear_count_bin_total(5)) ', Bin6: ' num2str(nonlinear_count_bin_total(6))]);
    disp('Short:')
