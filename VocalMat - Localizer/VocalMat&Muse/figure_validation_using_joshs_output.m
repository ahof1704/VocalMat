...
frac_less_than_1_cm=mean(e_mag<0.01)  %#ok
frac_less_than_2_cm=mean(e_mag<0.02)  %#ok
frac_less_than_3_cm=mean(e_mag<0.03)  %#ok
frac_less_than_4_cm=mean(e_mag<0.04)  %#ok
frac_less_than_5_cm=mean(e_mag<0.05)  %#ok
frac_less_than_6_cm=mean(e_mag<0.06)  %#ok
frac_less_than_7_cm=mean(e_mag<0.07)  %#ok
frac_less_than_8_cm=mean(e_mag<0.08)  %#ok
frac_less_than_9_cm=mean(e_mag<0.09)  %#ok
frac_less_than_10_cm=mean(e_mag<0.10)  %#ok
