function [suspicious,dataperfly,params] = ...
  suspicious_sequences_in_memory(trp,center_dampen,angle_dampen,max_jump,maxmajor,meanmajor,varargin)
...
%dataperfly = trp;
% else
dataperfly = addOffsetsToTracks(trp);
