...
iNumHeadTailChecked = 0;
iNumHeadTailCheckedHuddling = 0;
for iIter=1:iNumChecked
    ...
    [abHeadTailSwap, abNeitherHeadTail, abUnknown] = fnIsHeadTailSwap(astrctTrackersPos_Viterbi,astrctTrackersPos_GT,strctGT.astrctGT(iKeyFrameIndex),a2iCorrectPerm(iIter,:));
    iNumHeadTailSwap = iNumHeadTailSwap + sum(abHeadTailSwap);
    iNumHeadTailSwapHuddling = iNumHeadTailSwapHuddling + (sum(abHeadTailSwap) * bHuddling);
    iNumNeitherHeadTail = iNumNeitherHeadTail + sum(abNeitherHeadTail);
    iNumNeitherHeadTailHuddling = iNumNeitherHeadTailHuddling + (sum(abNeitherHeadTail) * bHuddling);
    iNumHeadTailChecked = iNumHeadTailChecked + sum(~abUnknown);
    iNumHeadTailCheckedHuddling = iNumHeadTailCheckedHuddling + (sum(~abUnknown) * bHuddling);
