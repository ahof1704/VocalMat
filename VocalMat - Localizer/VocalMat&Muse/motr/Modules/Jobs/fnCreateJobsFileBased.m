function fnCreateJobsFileBased(strMovieFileName, ...
                               strReliableFramesFileName,...
                               strAdditionalInfoFileName, ...
                               acstrJobOutFileNamesAbs, ...
                               acstrJobarginFileNamesAbs)
...
% Load the reliable frames 
astrctReliableFrames=fnLoadAnonymous(strReliableFramesFileName);
...
for iJobIter=1:iNumIntervals
  ...
  strJobOutFileName = acstrJobOutFileNamesAbs{iJobIter};
  strJobarginFileName = acstrJobarginFileNamesAbs{iJobIter};
  fnCreateJob(strMovieFileName, ...
              ...
              iJobIter, ...
              strJobarginFileName);
  acstrJobOutFileNamesAbs{iJobIter}=strJobOutFileName;          
  acstrJobarginFileNamesAbs{iJobIter}=strJobarginFileName;          
end
