function [astrctIntervals,abBinary] = fnHysteresisThresholdLow(afData, fLowThres, fHighThres, iMinimumLength)
...
aiLabelsHigh = bwlabeln(afData < fLowThres);
[aiLabelsLow,iNumCC] = bwlabeln(afData < fHighThres);
