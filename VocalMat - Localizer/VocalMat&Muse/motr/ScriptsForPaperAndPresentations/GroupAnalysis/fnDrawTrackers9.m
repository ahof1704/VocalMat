function a2bI = fnDrawTrackers9(fX,fY,fA,fB,fTheta,afXRange,afYRange)
%
...
a2bI = zeros(length(afYRange),length(afXRange))>0;
a2bI = roipoly(afXRange,afYRange,a2bI,apt2fFinal(1,:), apt2fFinal(2,:));
