...
for iCageIter=1:iNumCages
    ...
    strctData = load(strDatfile);
     ...
     strCumPosfile = [strFolder,'cage',num2str(aiCages(iCageIter)),'_CumutlativePositionCropped.mat'];
...
%     load(strCumPosfile);
% else
        [a4fCumulative]= fnComputeFavoritePlaces(strctData,fTimeThresholdMin);
