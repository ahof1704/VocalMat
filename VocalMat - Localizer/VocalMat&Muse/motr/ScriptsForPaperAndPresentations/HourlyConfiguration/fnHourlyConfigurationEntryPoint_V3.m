...
for iCageIter=1:iNumCages
    ...
    for iMouseIter = 1:4
        ...
        X = [X;strctData.X(abNotMoving,iMouseIter)];
        Y = [Y;strctData.Y(abNotMoving,iMouseIter)];
    end
    ...
    a2fCenterSmoothLogFiltered(a2fCenterSmoothLogFiltered<fPositionThreshold) =0;
    ...
    set(gca,'ytick',[-1:iNumDwellingPlaces],'xlim',[0 afSampleTimeHours(end)] ,'ylim',[-0.95 iNumDwellingPlaces-1]);
    for j=0:12:120
