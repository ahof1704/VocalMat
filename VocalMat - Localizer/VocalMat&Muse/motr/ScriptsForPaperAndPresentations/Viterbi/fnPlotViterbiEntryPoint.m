X=load('D:\Data\Janelia Farm\Results\10.04.19.390_cropped_120-175\SequenceRAW_28-Mar-2010.mat');

astrctTrackers = X.astrctTrackers;
fSwapPenalty = -200;
...
for iMouseIter=1:iNumMice
    a3fLogProb(:,:,iMouseIter) = log10(astrctTrackers(iMouseIter).m_a2fClassifer);
end
...
abLargeTimeGap = zeros(1,size(a2fLikelihood,2))>0;
...
figure(10);
clf;
imagesc(a2fLikelihood,[-10 1]);
[afDummy, aiInd]=max(a2fLikelihood,[],1);
set(gca,'xlim',[0 25000])
set(gca,'xticklabel',[])
set(gca,'yticklabel',[])
set(gca,'ytick',[])
colorbar
set(gcf,'position',[  737   502   480   240])
...
set(gca,'yticklabel',[])
set(gca,'ytick',[])
set(gcf,'position',[  737   502   410   198])
hold on;
plot(aiInd,'m','LineWidth',1);
