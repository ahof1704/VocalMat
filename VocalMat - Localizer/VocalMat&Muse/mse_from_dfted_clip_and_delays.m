function [mse,a]=mse_from_dfted_clip_and_delays(V,dt,tau_at_point,~)
...
a=sqrt(V_ss_per_mike)/N;  % volts, gain estimate, proportional to 
                          % RMS amp (in time domain)
A2=(a*a');  % volts^2
