...
test = 'D';
dir1 = 'C:\Users\neunuebelj\Documents\Lab\Beamforming\beamforming10\Beamforming03022012\demux';%'C:\Users\neunuebelj\Documents\Lab\Beamforming\beamforming4\Beamforming01042012\demux';%
dir2 = 'C:\Users\neunuebelj\Documents\Lab\Beamforming\beamforming10\Beamforming03022012';%'C:\Users\neunuebelj\Documents\Lab\Beamforming\beamforming4\Beamforming01042012';%
...
if strcmp(determine_mice_pos,'y')==1
    ...
    while i < 20%size(mouse,2)
        ...
        plot(foo(2).x_tail,foo(2).y_tail,'ws','MarkerSize',5,'MarkerFaceColor','w')
        correct_string = 'n';
        loop_number1 = 0;
        clear foo
        hold off
...
if strcmp(calcualte_TDOA,'y')==1
    ...
    for i = 1:20%size(mouse,2)
        [TDOA max_corr]= fn_TDOA_estimates(dir1, saving_dir, audio_fname_prefix, fc , mouse, i, Vsound);
        mouse(i).TDOA = TDOA;
