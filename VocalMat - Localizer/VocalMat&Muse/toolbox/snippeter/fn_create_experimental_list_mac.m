function [ date_str,let_str,base_dir_name] = fn_create_experimental_list_mac( varargin )
...
%single mouse data
base_dir_name{end+1} = '/Volumes/egnorlab/Neunuebel/ssl_sys_test';
base_dir_name{end+1} = '/Volumes/egnorlab/Neunuebel/ssl_sys_test';
base_dir_name{end+1} = '/Volumes/egnorlab/Neunuebel/ssl_sys_test';
base_dir_name{end+1} = '/Volumes/egnorlab/Neunuebel/ssl_sys_test';
base_dir_name{end+1} = '/Volumes/egnorlab/Neunuebel/ssl_sys_test';
...
base_dir_name{end+1} = '/Volumes/egnorlab/Neunuebel/ssl_sys_test';
%multiple mouse data
base_dir_name{end+1} = '/Volumes/egnorlab/Neunuebel/ssl_vocal_structure/';
base_dir_name{end+1} = '/Volumes/egnorlab/Neunuebel/ssl_vocal_structure/';
base_dir_name{end+1} = '/Volumes/egnorlab/Neunuebel/ssl_vocal_structure/';
base_dir_name{end+1} = '/Volumes/egnorlab/Neunuebel/ssl_vocal_structure/';
base_dir_name{end+1} = '/Volumes/egnorlab/Neunuebel/ssl_vocal_structure/';
