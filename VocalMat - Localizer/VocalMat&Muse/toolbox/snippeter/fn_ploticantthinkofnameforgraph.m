function [convex_set_x, convex_set_y, convex_hull, area_convex_hull, in] = fn_ploticantthinkofnameforgraph(dir2, dir3, num_iteration, randomized_cords_r, random_mean_mice, trv, mouse_num, vfilename, j, mouse, meters_2_pixels )
