        ...
        if isempty(X)==0
            ...
            if strcmp(odd_voc,'n')==1
                ...
                elseif size(coords_chunks,2)>1 && size(coords_chunks,2)<=3
                    ...
                    %                     outliers_k = [];
                    %                     outliers(i).bad = NaN;
                    %                     fn_plot_chunks(centroid_chunks, C, i, coords_mouse2,Pos_X,Pos_Y,Xrange,Yrange,Xrange_m,Yrange_m,corners_x,corners_y,X,Y,coords_chunks,outliers_k,p,'good',subplot_options,video_fname_prefix)
                    %                 else
                    %                     odd_voc_count = odd_voc_count + 1;
                    %                     odd_voc_list(odd_voc_count,1) = i;
                    %                     odd_voc_list(odd_voc_count,2) = 1;
                    ...
                    %                     outliers_k = [];
                    %                     outliers(i).bad = NaN;
                    %                     fn_plot_chunks(centroid_chunks, C, i, coords_mouse2,Pos_X,Pos_Y,Xrange,Yrange,Xrange_m,Yrange_m,corners_x,corners_y,X,Y,coords_chunks,outliers_k,p,'bad',subplot_options,video_fname_prefix)
                    %                 end
