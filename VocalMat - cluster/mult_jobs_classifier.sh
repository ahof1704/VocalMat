...
export FOLDER=/ysm-gpfs/project/ahf38/Antonio_VocalMat/USVs/NZO
...
#  OUT0=$(sbatch -J $identifier -o $p.stdout.txt -e $p.stderr.txt /ysm-gpfs/project/ahf38/Antonio_VocalMat/VocalMat-Identifier/VocalMat_Ident_job.sh ${p} ${folder_name})
  ...
  OUT1=$(sbatch -J $classifier -o $name3.stdout.txt -e $name3.stderr.txt /ysm-gpfs/project/ahf38/Antonio_VocalMat/VocalMat-Classifier/VocalMat_Class_batch.sh ${name3})
